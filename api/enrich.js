...
- Pain score 1-100 for needing an AI receptionist
...
{"ownerName":"...","email":"...","phone":"...","rating":"4.1","pain":45,"confidence":"low|medium|high"}`;
    ...
    if (enriched.email) {
      ...
      if (idx !== -1) {
        ...
        prospects[idx].rating = enriched.rating || prospects[idx].rating;
